...
def print_words(filename):
    """
    Conta a frequência de palavras de um arquivo e imprime as palavras
    em ordem alfabética, com sua frequência.
    """
    d = {}
...
def print_top(filename):
    """
    Conta a frequência de palavras de um arquivo e imprime as 20 palavras
    mais frequentes em ordem decrescente de frequência.
    """
    d = {}
    with open(filename, 'r') as f:
        for line in f:
            ...
            for word in words:
                ...
                if word in d:
                    ...
                    d[word] = 1
    word_counts = d.items()
    sorted_word_counts = sorted(word_counts, key=lambda word_count: word_count[1], reverse=True)
